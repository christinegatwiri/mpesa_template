...
DEFAULT_FILE_STORAGE = 'ian_test_proj.settings.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'ian_test_proj.settings.aws.utils.StaticRootS3BotoStorage'
