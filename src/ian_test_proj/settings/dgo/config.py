...
DEFAULT_FILE_STORAGE = "ian_test_proj.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "ian_test_proj.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "ian_test_proj.settings.dgo.utils.MediaRootS3BotoStorage"
